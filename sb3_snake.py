...
def build_arg_parser():
    ...
    pt.add_argument("--batch-size", type=int, default=ENV_BATCH_SIZE, help=f"Batch size (default: {ENV_BATCH_SIZE})")
    pt.add_argument("--gamma", type=float, default=DEFAULT_GAMMA, help=f"Discount factor (default: {DEFAULT_GAMMA})")
    pt.add_argument("--eps-start", type=float, default=DEFAULT_EPS_START, help=f"initial value of random action probability (default: {DEFAULT_EPS_START})")
    pt.add_argument("--eps-end", type=float, default=DEFAULT_EPS_END, help=f"final value of random action probability (default: {DEFAULT_EPS_END})")
    ...
    pt.add_argument("--target-update", type=int, default=DEFAULT_TARGET_UPDATE, help=f"Target network update frequency in steps (default: {DEFAULT_TARGET_UPDATE})")
