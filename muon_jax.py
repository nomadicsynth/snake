...
def muon(
    ...
    def update_fn(updates, state, params=None):
        ...
        new_updates = jax.tree_util.tree_unflatten(jax.tree_util.tree_structure(updates), updates_flat)
        new_momentum = jax.tree_util.tree_unflatten(jax.tree_util.tree_structure(state.momentum), momentum_flat)
